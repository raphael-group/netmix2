...
def run(args):
    ...
    est_subnetwork = netmix_edgedense(A_network, rho, zscores, alpha, edge_dense_linear=True, time_limit=3600*args.time_limit)
    ###########################################################
    # print solution
    ...
    # write solution
    if args.output:
        write_list_to_file(os.path.join(args.output, 'netmix_edge_dense_subnetwork.tsv'), est_subnetwork_genes)
